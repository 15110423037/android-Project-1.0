...
import com.harsh.threads.clone.databinding.ActivityMainBinding;
import com.harsh.threads.clone.fragments.ActivityNotificationFragment;
import com.harsh.threads.clone.fragments.AddThreadFragment;
import com.harsh.threads.clone.fragments.HomeFragment;
import com.harsh.threads.clone.fragments.ProfileFragment;
import com.harsh.threads.clone.fragments.SearchFragment;
...
//            fragmentTransaction.replace(R.id.fragmentContainerView, AddThreadFragment.getInstance()).addToBackStack(null).commit();
    ...
    private void onProfileUpdatePause() {
        // Handle pause logic for profile updates
    }

    private void onProfileUpdateResume() {
        // Handle resume logic for profile updates
    }
}